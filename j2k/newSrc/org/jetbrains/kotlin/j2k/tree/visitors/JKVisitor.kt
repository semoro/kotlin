...
interface JKVisitor<out R, in D> {
    ...
    fun visitSwitchCase(switchCase: JKSwitchCase, data: D): R = visitTreeElement(switchCase, data)
    fun visitDefaultSwitchCase(defaultSwitchCase: JKDefaultSwitchCase, data: D): R = visitSwitchCase(defaultSwitchCase, data)
    fun visitLabelSwitchCase(labelSwitchCase: JKLabelSwitchCase, data: D): R = visitSwitchCase(labelSwitchCase, data)
