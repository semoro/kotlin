...
interface JKVisitorVoid : JKVisitor<Unit, Nothing?> {
    ...
    fun visitSwitchStatement(switchStatement: JKSwitchStatement) = visitStatement(switchStatement, null)
    override fun visitSwitchStatement(switchStatement: JKSwitchStatement, data: Nothing?) = visitSwitchStatement(switchStatement)
    fun visitSwitchCase(switchCase: JKSwitchCase) = visitTreeElement(switchCase, null)
    override fun visitSwitchCase(switchCase: JKSwitchCase, data: Nothing?) = visitSwitchCase(switchCase)
    fun visitDefaultSwitchCase(defaultSwitchCase: JKDefaultSwitchCase) = visitSwitchCase(defaultSwitchCase, null)
    override fun visitDefaultSwitchCase(defaultSwitchCase: JKDefaultSwitchCase, data: Nothing?) = visitDefaultSwitchCase(defaultSwitchCase)
    fun visitLabelSwitchCase(labelSwitchCase: JKLabelSwitchCase) = visitSwitchCase(labelSwitchCase, null)
    override fun visitLabelSwitchCase(labelSwitchCase: JKLabelSwitchCase, data: Nothing?) = visitLabelSwitchCase(labelSwitchCase)
