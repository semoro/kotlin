...
interface JKVisitorVoid : JKVisitor<Unit, Nothing?> {
    ...
    fun visitJavaDefaultwitchCase(javaDefaultwitchCase: JKJavaDefaultwitchCase) = visitJavaSwitchCase(javaDefaultwitchCase, null)
    override fun visitJavaDefaultwitchCase(javaDefaultwitchCase: JKJavaDefaultwitchCase, data: Nothing?) = visitJavaDefaultwitchCase(javaDefaultwitchCase)
    ...
    fun visitKtDefaultWhenLabel(ktDefaultWhenLabel: JKKtDefaultWhenLabel) = visitKtWhenLabel(ktDefaultWhenLabel, null)
    override fun visitKtDefaultWhenLabel(ktDefaultWhenLabel: JKKtDefaultWhenLabel, data: Nothing?) = visitKtDefaultWhenLabel(ktDefaultWhenLabel)
