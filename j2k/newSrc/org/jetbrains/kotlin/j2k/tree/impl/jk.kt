...
class JKTypeElementImpl(override val type: JKType) : JKTypeElement, JKElementBase(), PsiOwner by PsiOwnerImpl() {
...
object JKNoTypeImpl: JKNoType {
    override val nullability: Nullability
        get() = error("Can not get nullability of JKNoType")
}
...
class JKSwitchStatementImpl(expression: JKExpression, block: JKBlock) : JKSwitchStatement, JKBranchElementBase(), PsiOwner by PsiOwnerImpl() {
    override var block by child(block)
    override var expression by child(expression)
    override fun <R, D> accept(visitor: JKVisitor<R, D>, data: D): R = visitor.visitSwitchStatement(this, data)
}

class JKSwitchLabelStatementImpl(expression: JKExpression) : JKSwitchLabelStatement, JKBranchElementBase(), PsiOwner by PsiOwnerImpl() {
    override var expression by child(expression)
    override fun <R, D> accept(visitor: JKVisitor<R, D>, data: D): R = visitor.visitSwitchLabelStatement(this, data)
}

class JKSwitchDefaultLabelStatementImpl : JKSwitchDefaultLabelStatement, JKElementBase(), PsiOwner by PsiOwnerImpl() {
